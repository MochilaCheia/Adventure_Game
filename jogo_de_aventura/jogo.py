...
sleep(tempo)
print('em uma aldeia onde os ataques ocasiões de monstros  costumam frequentes mas mesmo assim costuma ser um lugar calmo e pacato,')
sleep(tempo)
...
# FLAG: história continua aqui #1
        ...
        if acao == '1':
            ...
            sleep(tempo)
            print('Mas é possível ver um homem alto, segurando algo... uma bainha? NÃO! É SEM DÚVIDA NENHUMA UMA ESPADA!\n')
            sleep(tempo)
...
# FLAG: história continua aqui #5
            ...
            sleep(tempo)
            print('mas antes que tenha tempo pra virar e fugir, você é cercado por uma criatura... uma só? ou várias?\n')
            sleep(tempo)
            ...
            sleep(tempo)
            print('com pêlos escuros como a noite e no meio deles, tem tentáculos de um polvo gigante saindo, mas nem estamos perto do mar???')
            sleep(tempo)
